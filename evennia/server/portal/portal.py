...
WEBSOCKET_SERVER_INTERFACE = '127.0.0.1' if LOCKDOWN_MODE else settings.WEBSOCKET_SERVER_INTERFACE
...
WEBSOCKET_CLIENT_ENABLED = settings.WEBSOCKET_CLIENT_ENABLED and WEBSOCKET_SERVER_PORT and WEBSOCKET_SERVER_INTERFACE
        ...
        for proxyport, serverport in WEBSERVER_PORTS:
            ...
            if WEBCLIENT_ENABLED:
                ...
                if WEBSOCKET_CLIENT_ENABLED and not websocket_started:
                    ...
                    interface = WEBSOCKET_SERVER_INTERFACE
